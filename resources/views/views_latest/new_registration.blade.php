...
<body>
    ...
    <div class="login">
        <form action="{{url('admin/register/save')}}" method="post">
            ...
            <div class="input_box">
                <input type="text" required="true" name="name" placeholder="SMS Name" required>
                <i class='bx bxs-user'></i>
            </div>
            <div class="input_box">
                <input type="text" required="true" name="email" placeholder="Enter a valid email address" required>
                <i class='bx bxs-envelope'></i>
            </div>
            <div class="input_box">
                <input type="tel" name="number" required="true" placeholder="Enter a Valid Mobile Number" required>
