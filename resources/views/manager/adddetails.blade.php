...
<div class="col-12 col-lg-13 m-auto" style="margin-top: 30px !important;">
            <form class="multisteps-form__form" action="{{url('manager/adddetails/processing')}}" method="post" enctype="multipart/form-data">
              @csrf 
              <!--single form panel-->
                ...
                <div class="multisteps-form__content">
                  ...
                  <div class="form-row mt-4">
                    ...
                    <div class="col-12 col-sm-4 mt-4 mt-sm-0">
                     <label for="GenderId" class="form-control-label">College Lms Name :</label>
        ...
        @if($id>0)
         <img src="{{asset('managerimages')}}/{{$image}}" width="130px" height="80px" alt="Gallery Image">
         @endif
        </div>
                  </div>
                  ...
                  <div class="button-row d-flex mt-4">
                    ...
                    <a href="{{url('manager/dashboard')}}"><button type="button" class="btn btn-danger" style="margin-left:10px !important;">Back</button></a>
                  </div>
                </div>
              </div>
              </form>
