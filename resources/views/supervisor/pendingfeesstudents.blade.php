...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{url('supervisor/fees/pending/students/bysection')}}" method="post">
    @csrf
    <div class="form-row">
            ...
            <div class="card" style="margin-top:20px">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        @if(count($students)>0)
                        <a href="{{url('supervisor/fees/pending/students/export')}}/{{$class}}/{{$section}}" class="btn btn-success btn-sm">Export</a>
                        @else
