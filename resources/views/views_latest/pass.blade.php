        ...
        <form method="post" onsubmit="return setAction(this)">
            ...
            <div class="input_box">
                <select class="drop_down" name="drop_down" id="drop_down" required>
                    ...
                    <option class="opt" value="{{ url('admin/forgotpassword/check') }} ">Admin</option>
                    <option class="opt" value="{{ url('supervisor/forgotpassword/check') }} ">Stream Manager</option>
                    <option class="opt" value="{{ url('manager/forgotpassword/check') }} ">Specialization Manager</option>
                    <option class="opt" value="{{ url('classteacher/forgotpassword/check') }}">HoD</option>
                    <option class="opt" value="{{ url('faculty/forgotpassword/check') }}">Faculty</option>
                    <option class="opt" value="{{ url('student/forgotpassword/check') }}">Student</option>
                </select>
            </div>
            <div class="input_box">
