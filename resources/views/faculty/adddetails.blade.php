...
<div class="col-12 col-lg-13 m-auto" style="margin-top: 30px !important;">
            <form class="multisteps-form__form" action="{{url('faculty/adddetails/processing')}}" method="post" enctype="multipart/form-data">
              @csrf 
              <!--single form panel-->
                  ...
                  <div class="form-row mt-4">
                    ...
                    <div class="col-12 col-sm-3 mt-4 mt-sm-0" id="a">
                        ...
                        <select id="role" type="text" class="form-control" name="role" readonly="true">
                            ...
                            @if($role==$list->id)
                            <option selected value="{{$list->id}}">{{$list->role}}</option>
                            @endif
                            @endforeach
                       </select>
                    </div>
        ...
        @if($id>0)
         ...
         @endif
                  ...
                  <div class="button-row d-flex mt-4">
                    ...
                    <a href="{{url('faculty/dashboard')}}"><button type="button" class="btn btn-danger" style="margin-left:10px !important;">Back</button></a>
                  </div>
                </div>
              </div>
              </form>
