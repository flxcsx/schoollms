...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown dropdown-hover">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left:auto; right:10px;">
              <li><a href="{{url('classteacher/profile')}}" class="dropdown-item">Change Password </a></li>
              <li><a href="{{url('classteacher/logout')}}" class="dropdown-item">Logout</a></li>
            </ul>
          </li>     
  ...
  <!-- /.navbar -->
  <?php
  $a= session()->get('CLASSTEACHER_Name');
  $b= session()->get('CLASSTEACHER_CLASS');
  $c= session()->get('CLASSTEACHER_SECTION'); 
  $name=$a." ".$b." -".$c;
  ?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
   ...
   <a href="#" class="brand-link">
     <img src='{{asset("assets/images/clg.png")}}' alt="John Doe" alt="AdminLTE Logo"  style="width:40px;height:40px" />
      <span class="brand-text font-weight-dark" style="color:white;"><?php echo $name; ?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item menu-open">
            <a  href="{{url('classteacher/dashboard')}}" class="nav-link" class="@yield('dashboard_select')">
           ...
           <li class="nav-item">
            <a  href="{{url('classteacher/schedule/timetable')}}" class="nav-link" class="@yield('dashboard_schedule')">
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/schedule/index')}}" class="nav-link" class="@yield('dashboard_schedule')">
              <i class="nav-icon fas fa-bookmark"></i>
              <p>
               Schedule
              </p>
           ...
           <li class="nav-item">
            <a  href="{{url('classteacher/infrastructure/info')}}" class="nav-link" class="@yield('dashboard_infra')">
              <i class="nav-icon fas fa-bookmark"></i>
              <p>
               Infrastructure
              </p>
      ...
      <li class="nav-item">
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/attendance/view/dates')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/distribution/add')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Distribution
              </p>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview" >
               <li class="nav-item">
            <a href="{{url('classteacher/fees/pending')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Last Year Pending 
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('classteacher/fees/index/students')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/reports')}}" class="nav-link" >
              <i class="far fa-circle nav-icon"></i>
              <p>
              Academic Reports
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/assignments')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Assignment Reports
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/attendance/report/view/months')}}" class="nav-link" >
              <i class="far fa-circle nav-icon"></i>
              <p>
              Attendance Reports
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/competition/reports')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Competition Reports
              </p>
         ...
         <li class="nav-item">
            ...
            <ul class="nav nav-treeview" >
               <li class="nav-item">
            <a href="{{url('classteacher/analytics/pendingfees')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Pending Fees
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('classteacher/analytics/currentfees')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Academic Fees
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/analytics')}}" class="nav-link" >
              <i class="far fa-circle nav-icon"></i>
              <p>
              Academic Analytics
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/analytic/assignment')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/analytics/attendance')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a  href="{{url('classteacher/analytics/competition')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
