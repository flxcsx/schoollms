  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
   ...
   <a href="#" class="brand-link">
     <img src='{{asset("assets/images/clg.png")}}' alt="John Doe" alt="AdminLTE Logo"  style="width:40px;height:40px" />
      <span class="brand-text font-weight-dark" style="color:white;"><?Php echo session()->get('ADMIN_Name'); ?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                   <a href="{{url('admin/department')}}" class="nav-link" class="@yield('manager_select')">
              ...
              <li class="nav-item">
                    <a href="{{url('admin/approve/leave')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Leave Mgmt</p>
                    </a>
              </li>
               <li class="nav-item">
            <a href="{{url('admin/fees/busroute')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Bus Route
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('admin/hostel')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Hostel
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('admin/cafeteria')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Cafeteria
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('admin/infrastructure/group')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                  <li class="nav-item">
                   <a href="{{url('admin/supervisor')}}" class="nav-link" class="@yield('manager_select')">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                    Group Manager
                   </p>
                    ...
                    <li class="nav-item">
                    <a href="{{url('admin/manager')}}" class="nav-link" class="@yield('manager_select')">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                     Manager
                    </p>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                  <li class="nav-item">
                   <a href="{{url('admin/nontech/supervisor')}}" class="nav-link" class="@yield('manager_select')">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                    Group Manager
                   </p>
                    ...
                    <li class="nav-item">
                    <a href="{{url('admin/nontech/manager')}}" class="nav-link" class="@yield('manager_select')">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                     Manager
                    </p>
                  ...
                  <li class="nav-item">
                    <a href="{{url('admin/nontech/staff')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Staff</p>
                    </a>
                  </li>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a href="{{url('admin/category')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Standard
              </p>
              ...
              <li class="nav-item">
            <a href="{{url('admin/domain')}}" class="nav-link" class="@yield('Questions_select')">
               <i class="far fa-circle nav-icon"></i>
              <p>
                Subject
              </p>
            ...
            <li class="nav-item">
            <a href="{{url('admin/skillset')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Module
              </p>
            ...
            <li class="nav-item">
            <a href="{{url('admin/skillattribute')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Chapter
              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" >
                ...
                <li class="nav-item">
            <a href="{{url('admin/fees/distance')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Pickup/Drop Location
                   ...
                   <li class="nav-item">
            <a href="{{url('admin/fees/category')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Fees Category
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('admin/fees/schedule')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="{{url('admin/transport/fees/schedule/busroutes')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" >
                   <li class="nav-item">
            <a href="{{url('admin/periods/portal')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
              Staff Wise
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('admin/periods/class')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
              Class Wise
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('admin/schedule/index')}}" class="nav-link" class="@yield('list')">
              <i class="far fa-circle nav-icon"></i>
              <p>
              Subject Wise
              </p>
          ...
          <li class="nav-item" style="display:none">
            <a href="{{url('admin/periods/subject')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Subject Wise
              </p>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
             <li class="nav-item">
            <a href="{{url('admin/assesments')}}" class="nav-link" class="@yield('Questions_select')">
               <i class="far fa-circle nav-icon"></i>
              <p>
                Assesment Creation 
              </p>
               ...
               <li class="nav-item">
            <a href="{{url('admin/questions')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Question Bank
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('admin/questions/mismatch')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Answer Mismatch
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('admin/questions/improper')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Improper Question
              </p>
      ...
      <li class="nav-item">
            ...
            <ul class="nav nav-treeview" >
          <li class="nav-item">
            <a href="{{url('admin/fees/pending')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Last Year Pending 
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('admin/fees/pending/currentyear')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
           ...
           <li class="nav-item">
            <a href="{{url('admin/fees/index/students')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
        ...
        <li class="nav-item">
            <a  href="{{url('admin/attendance/view/months')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Attendance Reports
              </p>
        ...
        <li class="nav-item">
            <a  href="{{url('admin/competition/reports')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Competition Reports
              </p>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview" >
               <li class="nav-item">
            <a href="{{url('admin/analytics/pendingfees')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Pending Fees
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('admin/analytics/currentfees')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Current Year Payment
              </p>
        ...
        <li class="nav-item">
            <a  href="{{url('admin/analytics/attendance')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
        ...
        <li class="nav-item">
            <a  href="{{url('admin/analytics/competition')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
