...
<div class="col-12 col-lg-13 m-auto" style="margin-top: 30px !important;">
            <form class="multisteps-form__form" action="{{url('supervisor/adddetails/processing')}}" method="post" enctype="multipart/form-data">
              @csrf 
              <!--single form panel-->
              <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="FadeIn">
                ...
                <div class="form-row mt-4">
                    ...
                    <div class="col-12 col-sm-3 mt-4 mt-sm-0" id="a">
                        ...
                        <select id="group" type="text" class="form-control" name="group" readonly="true">
              ...
              <div class="form-row mt-4">
                    ...
                    <div class="col-12 col-sm-3 mt-4 mt-sm-0">
                      ...
                      @if($id>0)
                      <img src="{{asset('supervisorimages')}}/{{$image}}" width="130px" height="80px" alt="Gallery Image">
                      @endif
                    </div>
                  ...
                  <div class="button-row d-flex mt-4">
                    ...
                    <a href="{{url('supervisor/dashboard')}}"><button type="button" class="btn btn-danger" style="margin-left:10px !important;">Back</button></a>
                  </div>
                </div>
              </div>
              </form>
