...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown dropdown-hover">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left:auto; right:10px;">
              <li><a href="{{url('supervisor/profile')}}" class="dropdown-item">Change Password </a></li>
              <li><a href="{{url('supervisor/logout')}}" class="dropdown-item">Logout</a></li>
            </ul>
          </li>     
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
   ...
   <a href="#" class="brand-link">
     <img src='{{asset("assets/images/clg.png")}}' alt="John Doe" alt="AdminLTE Logo"  style="width:40px;height:40px" />
      <span class="brand-text font-weight-dark" style="color:white;"><?Php echo session()->get('SUPERVISOR_Name'); ?></span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item menu-open">
            <a  href="{{url('supervisor/dashboard')}}" class="nav-link" class="@yield('dashboard_select')">
    ...
    <li class="nav-item">
            ...
            <!--    <li class="nav-item">
            <a href="{{url('supervisor/portal/list')}}" class="nav-link" class="@yield('Questions_select')">
          ...
          @if(session()->get('SUPERVISOR_TYPE')==1)
            <li class="nav-item">
            <a href="{{url('supervisor/utilization')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                 Staff Utilization
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('groupmanager/utilization/class')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                 Class Utilization
              </p>
          ...
          @else
           <li class="nav-item">
            <a href="{{url('groupmanager/optional/utilization')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                 Subject Utilization
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('groupmanager/optional/utilization/class')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                 Class Utilization
              </p>
    ...
    <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
            <li class="nav-item">
                    <a href="{{url('supervisor/apply/leave')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Apply Leave</p>
                    </a>
            </li>
            <li class="nav-item">
            <a href="{{url('supervisor/approve/leave')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Approve Leave
              </p>
    ...
    <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
          <li class="nav-item">
            <a  href="{{url('groupmanager/staff/pendingandextra/classes')}}" class="nav-link" class="">
               <i class="far fa-circle nav-icon"></i>
              <p>
               Staff Scheduling
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('groupmanager/rescheduling/list')}}" class="nav-link" class="">
               <i class="far fa-circle nav-icon"></i>
              <p>
               Class Rescheduling
              </p>
      ...
      <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
          <li class="nav-item">
            <a  href="{{url('supervisor/distribution/reports')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>Distribution</p>
            </a>
          </li>
      ...
      <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>
                ...
                <ul class="nav nav-treeview" style="display: none;">
                  <li class="nav-item">
            <a href="{{url('groupmanager/competition')}}" class="nav-link" class="@yield('Questions_select')">
               <i class="far fa-circle nav-icon"></i>
              <p>
                Add 
              </p>
    ...
    <li class="nav-item">
            ...
            <ul class="nav nav-treeview" >
               <li class="nav-item">
            <a href="{{url('supervisor/fees/pending')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Last Year Pending 
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('supervisor/fees/index/students')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a  href="{{url('supervisor/reports')}}" class="nav-link" class="">
               <i class="far fa-circle nav-icon"></i>
              <p>
               Academic Reports
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('supervisor/assignments')}}" class="nav-link" class="">
               <i class="far fa-circle nav-icon"></i>
              <p>
               Assignment Reports
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('supervisor/attendance/view/months')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>Attendance Reports</p>
            </a>
          </li>
          <li class="nav-item">
            <a  href="{{url('supervisor/competition/reports')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Competition Reports
              </p>
  ...
  <li class="nav-item">
            ...
            <ul class="nav nav-treeview" >
               <li class="nav-item">
            <a href="{{url('supervisor/analytics/pendingfees')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Pending Fees
              </p>
           ...
           <li class="nav-item">
            <a href="{{url('supervisor/analytics/currentfees')}}" class="nav-link" class="@yield('Questions_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Academic Fees
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('supervisor/analytics')}}" class="nav-link" class="">
               <i class="far fa-circle nav-icon"></i>
              <p>
               Academic Analytics
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('supervisor/analytic/assignment')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a  href="{{url('supervisor/analytics/attendance')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a  href="{{url('supervisor/analytics/competition')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
