        ...
        <form method="post" onsubmit="return setAction(this)">
            ...
            <div class="input_box" id="external_user">
                ...
                <select class="drop_down" name="external" id="external" required>
                    ...
                    <option class="opt" value="{{ url('admin/login/save') }} ">Admin</option>
                    <option class="opt" value="{{ url('supervisor/login/save') }} ">Group Manager</option>
                    <option class="opt" value="{{ url('manager/login/save') }} ">Manager</option>
                    <option class="opt" value="{{ url('classteacher/login/save') }}">Class Teacher</option>
                    <option class="opt" value="{{ url('faculty/login/save') }}">Faculty</option>
                    <option class="opt" value="{{ url('student/login/save') }}">Student</option>
                </select>
            </div>
