@extends('supervisor/layout') @section('title','Date') @section('Dashboard_select','active extra') @section('container') <style type="text/css"></style>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{url('supervisor/attendance/view/students/bydate')}}" method="post">
    @csrf
    <div class="form-row">
...
jQuery(document).ready(function(){
    jQuery('#topbranch').change(function (){
        ...
        jQuery.ajax({
            url:'{{url("supervisor/attendance/view/sections")}}',
            type:'get',
    ...
    jQuery('#subbranch').change(function (){
        ...
        jQuery.ajax({
            url:'{{url("supervisor/attendance/view/dates")}}',
            type:'get',
