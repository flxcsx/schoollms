        ...
        <form method="post" onsubmit="return setAction(this)">
            ...
            <div class="input_box">
                <select class="drop_down" name="drop_down" id="drop_down" required>
                    ...
                    <option class="opt" value="{{ url('supervisor/forgotpassword/check') }} ">Group Manager</option>
                    <option class="opt" value="{{ url('manager/forgotpassword/check') }} ">Manager</option>
                    <option class="opt" value="{{ url('classteacher/forgotpassword/check') }}">Class Teacher</option>
