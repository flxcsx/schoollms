...
<div class="col-12 col-lg-13 m-auto" style="margin-top: 30px !important;">
            <form class="multisteps-form__form" action="{{url('classteacher/adddetails/processing')}}" method="post" enctype="multipart/form-data">
              @csrf 
              <!--single form panel-->
              <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="FadeIn">
                ...
                <div class="multisteps-form__content">
                  ...
                  <div class="form-row mt-4">
                    ...
                    <div class="col-12 col-sm-4 mt-4 mt-sm-0" id="a">
                        <label for="role">Assigned Subjects :</label>
                        <select id="role" type="text" class="form-control" name="role" readonly="true">
                            @foreach($subject as $list)
                            <option selected value="{{$list->id}}">{{$list->domain}}</option>
                            @endforeach
                       </select>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 mt-4 mt-sm-0" id="a">
                        ...
                        <select id="role" type="text" class="form-control" name="class" readonly="true">
                ...
                <div class="form-row mt-4">
                    ...
                    <div class="col-12 col-sm-3 mt-4 mt-sm-0">
                      ...
                      @if($id>0)
                      <img src="{{asset('facultyimages')}}/{{$image}}" width="130px" height="80px" alt="Gallery Image">
                      @endif
                    </div>
                  ...
                  <div class="button-row d-flex mt-4">
                    ...
                    <a href="{{url('classteacher/dashboard')}}"><button type="button" class="btn btn-danger" style="margin-left:10px !important;">Back</button></a>
                  </div>
                </div>
              </div>
              </form>
